...
- [Configuration](../guides/configuration/) — categories, rules, keep-list, and building your config from your inbox.
- [CLI reference](../guides/cli/) — every command and flag.
- [MCP server](../guides/mcp-server/) — drive the same pipelines from an agent.
- See [`examples/`](https://github.com/ahmadatallah/fast-classifier/tree/main/examples) for a full real-world config.
